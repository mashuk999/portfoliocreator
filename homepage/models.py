...
class Education(models.Model):
    ...
    edorgname = models.CharField(max_length=20)
    eddate = models.CharField(max_length=20)
    eddetails = models.CharField(max_length=20)
...
class Experience(models.Model):
    ...
    eorgname = models.CharField(max_length=20)
...
class Achievement(models.Model):
    ...
    aorgname = models.CharField(max_length=20)
...
class Projects(models.Model):
    ...
    purl = models.CharField(max_length=20)
